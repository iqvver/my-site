  ...
  return (
    <div className="politica">
      ...
      <p>
        ...
        которую сайт <strong>Valerii[Pavlov] Frontend Developer</strong>, (далее
        – V[P]Frontend) расположенный на доменном имени{" "}
        <strong>https://iqvver.github.io/my-site/</strong> (а также его
        субдоменах), может получить о Пользователе во время использования сайта
        https://iqvver.github.io/my-site/ (а также его субдоменов), его программ
        и его продуктов.
      </p>
      ...
      <p>
        ...
        <strong>Valerii[Pavlov] Frontend Developer</strong>, которые организуют
      ...
      <p>
        1.1.5. «Сайт <strong> Valerii[Pavlov] Frontend Developer</strong>» - это
      ...
      <p>
        ...
        Valerii[Pavlov] Frontend Developer, а также другие временные страницы,
        внизу который указана контактная информация Администрации
      </p>

      <p>
        1.1.5. «Пользователь сайта{" "}
        <strong>Valerii[Pavlov] Frontend Developer</strong> » (далее
        Пользователь) – лицо, имеющее доступ к сайту{" "}
        <strong>Valerii[Pavlov] Frontend Developer</strong>, посредством сети
        Интернет и использующее информацию, материалы и продукты сайта{" "}
        <strong>Valerii[Pavlov] Frontend Developer</strong>.
      </p>
      ...
      <p>
        ...
        через который Пользователь получает доступ на V[P]Frontend.
      </p>

      <h2>2. Общие положения</h2>
      <p>
        2.1. Использование сайта Valerii[Pavlov] Frontend Developer
        Пользователем означает согласие с настоящей Политикой конфиденциальности
        и условиями обработки персональных данных Пользователя.
      </p>

      <p>
        2.2. В случае несогласия с условиями Политики конфиденциальности
        Пользователь должен прекратить использование сайта Valerii[Pavlov]
        Frontend Developer .
      </p>

      <p>
        2.3. Настоящая Политика конфиденциальности применяется к сайту
        Valerii[Pavlov] Frontend Developer. V[P]Frontend не контролирует и не
        несет ответственность за сайты третьих лиц, на которые Пользователь
        может перейти по ссылкам, доступным на сайте Valerii[Pavlov] Frontend
        Developer.
      </p>
      ...
      <p>
        ...
        Valerii[Pavlov] Frontend Developer или при подписке на информационную
        e-mail рассылку.
      </p>
      ...
      <p>
        ...
        заполнения форм на сайте Valerii[Pavlov] Frontend Developer и включают в
      ...
      <p>
        3.3. V[P]Frontend защищает Данные, которые автоматически передаются при
        посещении страниц:
        <br />
        - IP адрес;
        <br />
      ...
      <p>
        ...
        сайта Valerii[Pavlov] Frontend Developer, требующим авторизации.
      </p>

      <p>
        3.3.2. V[P]Frontend осуществляет сбор статистики об IP-адресах своих
      ...
      <p>
        ...
        Valerii[Pavlov] Frontend Developer для его дальнейшей авторизации.
        <br />
        4.1.2. Предоставления Пользователю доступа к персонализированным данным
        сайта Valerii[Pavlov] Frontend Developer.
        <br />
        4.1.3. Установления с Пользователем обратной связи, включая направление
        уведомлений, запросов, касающихся использования сайта Valerii[Pavlov]
        Frontend Developer, обработки запросов и заявок от Пользователя.
        <br />
        ...
        Valerii[Pavlov] Frontend Developer, если Пользователь дал согласие на
        создание учетной записи.
        <br />
        4.1.7. Уведомления Пользователя по электронной почте.
        <br />
        4.1.8. Предоставления Пользователю эффективной технической поддержки при
        возникновении проблем, связанных с использованием сайта Valerii[Pavlov]
        Frontend Developer.
        <br />
        ...
        Valerii[Pavlov] Frontend Developer.
      </p>
      ...
      <p>
        ...
        данных, необходимых для использования сайта Valerii[Pavlov] Frontend
        Developer, и давать согласие на их обработку.
      </p>
      ...
      <p>
        ...
        которой он может иметь доступ как к части сайта Valerii[Pavlov] Frontend
        Developer, несет лицо, предоставившее такую информацию.
      </p>

      <p>
        7.5. Пользователь соглашается, что информация, предоставленная ему как
        часть сайта Valerii[Pavlov] Frontend Developer, может являться объектом
        ...
        такую информацию на сайте Valerii[Pavlov] Frontend Developer. <br />
      ...
      <p>
        ...
        свободном публичном доступе на сайте Valerii[Pavlov] Frontend Developer)
      ...
      <p>
        ...
        коммуникационных данных, содержащихся на сайте Valerii[Pavlov] Frontend
        Developer или передаваемых через него.
      </p>
      ...
      <p>
        ...
        размещенную пользователем на сайте Valerii[Pavlov] Frontend Developer,
        включая, но не ограничиваясь: информацию, защищенную авторским правом,
        без прямого согласия владельца авторского права.
      </p>
      ...
      <p>
        ...
        Арбитражного суда г. Калининград.
      </p>
